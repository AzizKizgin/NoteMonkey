...
struct Backgrounds {
    static let backgrounds: [NoteBackground] = [
        ...
        NoteBackground(id: "10", color: "#0579f5",createdAt: Date.now.addingTimeInterval(10*0.1)),
        NoteBackground(id: "11", color: "#c40e0e",createdAt: Date.now.addingTimeInterval(11*0.1)),
        NoteBackground(id: "12", color: "#fcba03",createdAt: Date.now.addingTimeInterval(12*0.1)),
        NoteBackground(id: "13", color: "#ff14ff",createdAt: Date.now.addingTimeInterval(13*0.1)),
        NoteBackground(id: "14", color: "#800db5",createdAt: Date.now.addingTimeInterval(14*0.1)),
        NoteBackground(id: "15", color: "#fca503",createdAt: Date.now.addingTimeInterval(15*0.1)),
        NoteBackground(id: "16", color: "#52390b",createdAt: Date.now.addingTimeInterval(16*0.1)),
        NoteBackground(id: "17", color: "#3EB489",createdAt: Date.now.addingTimeInterval(17*0.1))
        ]
}
